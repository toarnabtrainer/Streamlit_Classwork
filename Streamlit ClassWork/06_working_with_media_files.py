...
st.image("https://docs.streamlit.io/logo.svg", caption="Streamlit Logo", width=100)
# Audio
st.subheader("Audio")
audio = st.file_uploader("Upload an audio file:", type=["mp3", "wav", "aac"])
if audio is not None:
    st.audio(audio, format="audio/mp3")
else:
	st.info("Audio file will be located here.")
...
if video is not None:
	...
	st.info("Video file will be displayed here.")

# Use link to display video
st.video("https://www.youtube.com/watch?v=SyRy7xo--1U", format="video/mp4")
