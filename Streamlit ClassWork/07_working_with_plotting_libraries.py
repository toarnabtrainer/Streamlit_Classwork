...
st.write("Dataframe has no. of Rows = {} and no. of Columns = {}".format(df.shape[0],df.shape[1]))
...
fig, ax = plt.subplots()    # returns a figure instance and an object or an array of Axes objects
...
# Map
st.subheader("Map")
temp = pd.read_csv("./Resources/weather_data.csv")
st.write(temp)
st.write("Dataframe has no. of Rows = {} and no. of Columns = {}".format(temp.shape[0],temp.shape[1]))
